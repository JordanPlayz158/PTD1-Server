            ...
            post("/ptd2_save_12.php") {
                ...
                when (action) {
                    "loadAccount" -> call.respondText(
                        PTD2SWFController.loadAccount().second.formUrlEncode(),
                        ContentType.Application.FormUrlEncoded
                    )

                    "loadStory" -> call.respondText(
                        PTD2SWFController.loadStory(account).second.formUrlEncode(),
                        ContentType.Application.FormUrlEncoded
                    )

                    "load1on1" -> call.respondText(
                        PTD2SWFController.load1v1(account).second.formUrlEncode(),
                        ContentType.Application.FormUrlEncoded
                    )
                        ...
                        when (action) {
                            "loadStoryProfile" -> call.respondText(
                                PTD2SWFController.loadStoryProfile(
                                    account,
                                    whichProfile
                                ).second.formUrlEncode(), ContentType.Application.FormUrlEncoded
                            )

                            "deleteStory" -> call.respondText(
                                PTD2SWFController.deleteStory(
                                    account,
                                    whichProfile
                                ).second.formUrlEncode(), ContentType.Application.FormUrlEncoded
                            )

                            "saveStory" -> call.respondText(
                                PTD2SWFController.saveStory(
                                    account,
                                    whichProfile,
                                    parameters
                                ).second.formUrlEncode(), ContentType.Application.FormUrlEncoded
                            ...
                            "save1on1" -> call.respondText(
                                PTD2SWFController.save1v1(
                                    account,
                                    whichProfile,
                                    parameters
                                ).second.formUrlEncode(), ContentType.Application.FormUrlEncoded
                            ...
                            "delete1on1" -> call.respondText(
                                PTD2SWFController.delete1v1(
                                    account,
                                    whichProfile
                                ).second.formUrlEncode(), ContentType.Application.FormUrlEncoded
                            )
...
fun getAvailableSaveId(story: PTD2Story): Int {
    return transaction { (story.pokes.maxByOrNull { pokemon -> pokemon.swfId }?.swfId ?: 0) + 1 }
}
